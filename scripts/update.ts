...
const main = async () => {
    try {
        ...
        await db.insert(schema.lessons).values([
            ...
            { id: 20, unitId: 4, order: 5, title: "JP - Hiragana 5" },
        ]);
        ...
        await db.insert(schema.challengeOptions).values([ // JP - Lesson 2
            ...
            { challengeId: 18, imageSrc: "/jp_ku.svg", correct: true, text: "", audioSrc: "/jp_ku.mp3" },
            { challengeId: 18, imageSrc: "/jp_ki.svg", correct: false, text: "", audioSrc: "/jp_ki.mp3" },
            { challengeId: 18, imageSrc: "/jp_ka.svg", correct: false, text: "", audioSrc: "/jp_ka.mp3" },

            { challengeId: 19, imageSrc: "/jp_ke.svg", correct: true, text: "", audioSrc: "/jp_ke.mp3" },
            { challengeId: 19, imageSrc: "/jp_ki.svg", correct: false, text: "", audioSrc: "/jp_ki.mp3" },
            { challengeId: 19, imageSrc: "/jp_ku.svg", correct: false, text: "", audioSrc: "/jp_ku.mp3" },
            { challengeId: 19, imageSrc: "/jp_ko.svg", correct: false, text: "", audioSrc: "/jp_ko.mp3" },

            { challengeId: 20, imageSrc: "/jp_ke.svg", correct: false, text: "", audioSrc: "/jp_ke.mp3" },
            { challengeId: 20, imageSrc: "/jp_ku.svg", correct: false, text: "", audioSrc: "/jp_ku.mp3" },
            { challengeId: 20, imageSrc: "/jp_ko.svg", correct: true, text: "", audioSrc: "/jp_ko.mp3" },
            { challengeId: 20, imageSrc: "/jp_ka.svg", correct: false, text: "", audioSrc: "/jp_ka.mp3" },

            { challengeId: 21, imageSrc: "/jp_ka.svg", correct: false, text: "", audioSrc: "/jp_ka.mp3" },
            { challengeId: 21, imageSrc: "/jp_ko.svg", correct: false, text: "", audioSrc: "/jp_ko.mp3" },
            { challengeId: 21, imageSrc: "/jp_ke.svg", correct: false, text: "", audioSrc: "/jp_ke.mp3" },
            { challengeId: 21, imageSrc: "/jp_ki.svg", correct: true, text: "", audioSrc: "/jp_ki.mp3" },

            { challengeId: 22, imageSrc: "/house.svg", correct: true, text: "家", audioSrc: "/jp_house.mp3" },
            { challengeId: 22, imageSrc: "/book.svg", correct: false, text: "本", audioSrc: "/jp_book.mp3" },
            { challengeId: 22, imageSrc: "/car.svg", correct: false, text: "車", audioSrc: "/jp_car.mp3" },
        ]);
