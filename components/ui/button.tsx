  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        primary: "bg-brand-light text-primary-foreground hover:bg-sky-500/90 border-sky-600 border-b-4 active:border-b-0",
        primaryOutline: "bg-white text-brand-light hover:bg-slate-100",
        ...
        sidebarOutline: "bg-brand-sidebar_light text-brand border-brand border-2 hover:bg-brand-sidebar_dark transition-none",
        tertiary: "bg-brand text-primary-foreground hover:bg-brand-light90 border-brand-light border-b-4 active:border-b-0",
      },
      size: {
